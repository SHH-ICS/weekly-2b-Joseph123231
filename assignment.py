...
try:
    ...
    print("THIS SHOULD APPEAR IF THERE IS A VALUE ERROR")
...
if variable1 == 0:
    ...
    #if variable1 = nothing then python finds error then excicutes the except once the error is found

#if nothing is inputed then a message tells you to input a radius so the calculation can be done (NOT DONE YET) 
